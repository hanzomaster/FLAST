...
def flastKNN(outDir, projectBasePath, projectName, kf, dim, eps, k, sigma, params):
    ...
    pickleDumpKNN = os.path.join(
        outDir, "flast-k{}-sigma{}.pickle".format(k, sigma))
...
if __name__ == "__main__":
    ...
    for metric in ["cosine", "euclidean"]:
        for k in [3, 7]:
            ...
            (flakyTrain, nonFlakyTrain, flakyTest, nonFlakyTest, avgP, avgR, storage, avgTPrep,
             avgTPred) = flastKNN(outDir, projectBasePath, projectName, kf, dim, eps, k, sigma, params)
            with open(os.path.join(outDir, outFile), "a") as fo:
                fo.write("{},{},{},{},{},{},{},{},{}\n".format(
                    params["metric"], k, sigma, eps, avgP, avgR, storage, avgTPrep, avgTPred))
    ...
    for testSetSize in [0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1]:
        ...
        for sigma in [0.5, 0.95]:
            ...
            with open(os.path.join(outDir, outFile), "a") as fo:
                fo.write("{},{},{},{},{},{},{},{},{}\n".format(
                    trainingSetSize, k, sigma, eps, avgP, avgR, storage, avgTPrep, avgTPred))
